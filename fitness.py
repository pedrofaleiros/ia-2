...
pesos = {
    "Engenharia": [1.5, 1.5, 1, 1, 1, 1, 0.5, 1, 0.5, 0.5, 0.5],
    "Direito": [0.5, 0.5, 0.5, 0.5, 1.5, 0.5, 1, 1.5, 1.5, 1.5, 0.5],
    "Medicina": [1, 1, 1.5, 1.5, 1, 0.5, 0.5, 1, 1, 0.5, 0.5],
    "TI": [1.5, 1.5, 0.5, 1, 1, 1.5, 0.5, 0.5, 1, 0.5, 0.5],
    "Artes": [0.5, 0.5, 0.5, 0.5, 1, 0.5, 1.5, 1.5, 1.5, 1.5, 0.5],
    "Línguas": [0.5, 0.5, 0.5, 0.5, 1.5, 1.5, 1, 1, 1.5, 1, 0.5],
    "Psicologia": [0.5, 0.5, 0.5, 0.5, 1, 1, 1.5, 1.5, 1.5, 1, 0.5],
}
